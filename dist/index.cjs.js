...
const uniqueId__default = /* #__PURE__ */ _interopDefaultLegacy(uniqueId);
const noop__default = /* #__PURE__ */ _interopDefaultLegacy(noop);
...
const getThemeValue = function (path, fallback) {
...
const Svg = styled__default.default.svg(
  templateObject_3$b ||
    (templateObject_3$b = __makeTemplateObject(
...
let templateObject_2$o;
let templateObject_3$b;

const Icon$1Q = function (props) {
...
const getColor = function (_a) {
  const { color } = _a;
  const { theme } = _a;
  return getThemeValue(`colors.${color}`, color)(theme);
};
const getFontSize = function (_a) {
  const { fontSize } = _a;
  const { small } = _a;
...
const Text = styled__default.default.div(
  templateObject_1$_ ||
    (templateObject_1$_ = __makeTemplateObject(
      [
        "\n  color: ",
        ";\n  font-size: ",
        ";\n  font-weight: ",
...
let templateObject_1$_;

const TooltipText = styled__default.default(Text)(
  templateObject_1$Z ||
    (templateObject_1$Z = __makeTemplateObject(
...
let templateObject_1$Z;

const getExternalLinkProps = function () {
  return {
    target: "_blank",
...
const getDisabledStyles = function (_a) {
  const { $isLoading } = _a;
  const { theme } = _a;
  if ($isLoading === true) {
 ...
 */
const getOpacity = function (_a) {
  const _b = _a.$isLoading;
  const $isLoading = _b === void 0 ? false : _b;
  return $isLoading ? ".5" : "1";
};
const StyledButton = styled__default.default.button(
  templateObject_1$Y ||
    (templateObject_1$Y = __makeTemplateObject(
      [
...
const Button = function (props) {
  ...
  const rest = __rest(props, ["startIcon", "endIcon", "external", "className", "isLoading", "disabled", "children"]);
  ...
  return React__default.default.createElement(
    StyledButton,
    { $isLoading: isLoading, className: classNames.join(" "), disabled: isDisabled, ...internalProps, ...rest },
...
const IconButton = styled__default.default(Button)(
  templateObject_1$X ||
    (templateObject_1$X = __makeTemplateObject(
      ["\n  padding: 0;\n  width: ", ";\n"],
      ["\n  padding: 0;\n  width: ", ";\n"]
    )),
  function (_a) {
...
let templateObject_1$X;

const Icon$1M = function (props) {
  return React__default.default.createElement(
    Svg,
    { viewBox: "0 0 24 24", ...props },
    React__default.default.createElement("path", {
...
const Icon$1H = function (props) {
  return React__default.default.createElement(
    Svg,
    { viewBox: "0 0 24 24", ...props },
    React__default.default.createElement("path", {
      d: "M21 11.1835L9.83 11.1835L14.71 6.30347C15.1 5.91347 15.1 5.27347 14.71 4.88347C14.32 4.49347 13.69 4.49347 13.3 4.88347L6.71 11.4735C6.32 11.8635 6.32 12.4935 6.71 12.8835L13.29 19.4835C13.68 19.8735 14.31 19.8735 14.7 19.4835C15.09 19.0935 15.09 18.4635 14.7 18.0735L9.83 13.1835L21 13.1835C21.55 13.1835 22 12.7335 22 12.1835C22 11.6335 21.55 11.1835 21 11.1835Z",
    }),
    React__default.default.createElement("path", {
      d: "M4 19.1835C3.44771 19.1835 3 18.7358 3 18.1835L3 6.18347C3 5.63119 3.44772 5.18347 4 5.18347C4.55229 5.18347 5 5.63119 5 6.18347L5 18.1835C5 18.7358 4.55228 19.1835 4 19.1835Z",
    })
  );
};

const Icon$1G = function (props) {
  return React__default.default.createElement(
    Svg,
    { viewBox: "0 0 24 24", ...props },
    React__default.default.createElement("path", {
...
const Icon$1A = function (props) {
  const id = uniqueId__default.default("svg");
  return React__default.default.createElement(
    Svg,
    { viewBox: "0 0 64 64", ...props },
    React__default.default.createElement(
...
const Icon$1z = function (props) {
  const theme = styled.useTheme();
  const primaryColor = theme.isDark ? "#3C3742" : "#e9eaeb";
  const secondaryColor = theme.isDark ? "#666171" : "#bdc2c4";
  return React__default.default.createElement(
    Svg,
    { viewBox: "0 0 72 72", ...props },
    React__default.default.createElement("path", {
    ...
    React__default.default.createElement(
      "mask",
      { id: "mask0", "mask-type": "alpha", maskUnits: "userSpaceOnUse", x: "3", y: "3", width: "66", height: "66" },
      React__default.default.createElement("path", {
...
const StyledWrapper = styled__default.default.div(
  templateObject_1$W ||
    (templateObject_1$W = __makeTemplateObject(
      [
        "\n  max-height: ",
        "px;\n  max-width: ",
        'px;\n  position: relative;\n  width: 100%;\n\n  &:after {\n    content: "";\n    display: block;\n    padding-top: ',
...
const Wrapper$3 = React.forwardRef(function (_a, ref) {
  const { width } = _a;
  const { height } = _a;
  const props = __rest(_a, ["width", "height"]);
  return React__default.default.createElement(StyledWrapper, { ref, $width: width, $height: height, ...props });
});
let templateObject_1$W;

const StyledBackgroundImage = styled__default.default(Wrapper$3)(
  templateObject_1$V ||
    (templateObject_1$V = __makeTemplateObject(
      ["\n  background-repeat: no-repeat;\n  background-size: contain;\n"],
      ["\n  background-repeat: no-repeat;\n  background-size: contain;\n"]
    ))
);
const BackgroundImage = function (_a) {
  const { src } = _a;
  const { width } = _a;
  const { height } = _a;
  const props = __rest(_a, ["src", "width", "height"]);
  const ref = React.useRef(null);
  React.useEffect(
    function () {
      let observer;
      if (ref.current) {
        const div_1 = ref.current;
  ...
  return React__default.default.createElement(StyledBackgroundImage, { ref, width, height, ...props });
};
let templateObject_1$V;

const StyledImage = styled__default.default.img(
  templateObject_1$U ||
    (templateObject_1$U = __makeTemplateObject(
      ["\n  height: 100%;\n  left: 0;\n  position: absolute;\n  top: 0;\n  width: 100%;\n"],
      ["\n  height: 100%;\n  left: 0;\n  position: absolute;\n  top: 0;\n  width: 100%;\n"]
    ))
);
const Placeholder = styled__default.default.div(
  templateObject_2$n ||
    (templateObject_2$n = __makeTemplateObject(
      ["\n  height: 100%;\n  left: 0;\n  position: absolute;\n  top: 0;\n  width: 100%;\n"],
      ["\n  height: 100%;\n  left: 0;\n  position: absolute;\n  top: 0;\n  width: 100%;\n"]
    ))
);
const Image = function (_a) {
  const { src } = _a;
  const { alt } = _a;
  const { width } = _a;
  const { height } = _a;
  const props = __rest(_a, ["src", "alt", "width", "height"]);
  const imgRef = React.useRef(null);
  const _b = React.useState(false);
  const isLoaded = _b[0];
  const setIsLoaded = _b[1];
  React.useEffect(
    function () {
      let observer;
      if (imgRef.current) {
  ...
  return React__default.default.createElement(
    Wrapper$3,
    { ref: imgRef, height, width, ...props },
    isLoaded
      ? React__default.default.createElement(StyledImage, { src, alt })
      : React__default.default.createElement(Placeholder, null)
  );
};
let templateObject_1$U;
let templateObject_2$n;

const TokenImage = styled__default.default(Image)(
  templateObject_1$T ||
    (templateObject_1$T = __makeTemplateObject(
      [
...
let _a$4;
let _b$2;
const StyledPrimaryImage = styled__default.default(TokenImage)(
  templateObject_1$S ||
    (templateObject_1$S = __makeTemplateObject(
...
const StyledSecondaryImage = styled__default.default(TokenImage)(
  templateObject_2$m ||
    (templateObject_2$m = __makeTemplateObject(
      ["\n  position: absolute;\n  width: 50%;\n\n  ", "\n"],
      ["\n  position: absolute;\n  width: 50%;\n\n  ", "\n"]
    )),
  styledSystem.variant({
...
let templateObject_1$S;
let templateObject_2$m;

const TokenPairImage = function (_a) {
  const { primarySrc } = _a;
  const { secondarySrc } = _a;
  const { width } = _a;
  const { height } = _a;
  const _b = _a.variant;
  const variant = _b === void 0 ? variants$4.DEFAULT : _b;
  const _c = _a.primaryImageProps;
  const primaryImageProps = _c === void 0 ? {} : _c;
  const _d = _a.secondaryImageProps;
  const secondaryImageProps = _d === void 0 ? {} : _d;
  ...
  return React__default.default.createElement(
    Wrapper$3,
    { position: "relative", width, height, ...props },
    React__default.default.createElement(StyledPrimaryImage, {
      variant,
      src: primarySrc,
      width,
      height,
    ...
    React__default.default.createElement(StyledSecondaryImage, {
      variant,
      src: secondarySrc,
...
const Icon$1c = function (props) {
  props.width;
  props.height;
  const other = __rest(props, ["width", "height"]);
  return React__default.default.createElement(Image, {
    src: "/images/mlm/logo.png",
    width: 32,
    height: 32,
    ...other,
    alt: "MarmaladeSwap Logo",
  });
};
...
const Icon$1b = function (props) {
  return React__default.default.createElement(
    ...
    React__default.default.createElement("circle", {
      ...
      cy: "256",
      r: "256",
      fill: "url(#paint0_linear_logoround)",
    }),
    React__default.default.createElement("path", {
      fillRule: "evenodd",
      clipRule: "evenodd",
    ...
    React__default.default.createElement(
      ...
      React__default.default.createElement(
        "linearGradient",
        { id: "paint0_linear_logoround", x1: "256", y1: "0", x2: "256", y2: "512", gradientUnits: "userSpaceOnUse" },
...
const Icon$15 = function (props) {
  return React__default.default.createElement(
    Svg,
    { viewBox: "0 0 35 33", ...props },
    React__default.default.createElement("path", {
...
const Icon$13 = function (props) {
  ...
  return React__default.default.createElement(
    ...
    React__default.default.createElement(
      "mask",
      { id: "A", "mask-type": "alpha", maskUnits: "userSpaceOnUse", x: "0", y: "0", width: "32", height: "32" },
      React__default.default.createElement("path", {
        d: "M32 16c0 8.837-7.163 16-16 16S0 24.837 0 16 7.163 0 16 0s16 7.163 16 16z",
        fill: "#c4c4c4",
      })
...
const Icon$$ = function (props) {
  return React__default.default.createElement(
    Svg,
    { viewBox: "0 0 90 90", ...props },
    React__default.default.createElement("image", { href: "/images/mlm/logo.png", height: "100%", width: "100%" })
  );
};

const Icon$_ = function (props) {
  const id = uniqueId__default.default("svg");
  return React__default.default.createElement(
    Svg,
...
const Icon$X = function (props) {
  return React__default.default.createElement(
    Svg,
    { viewBox: "0 0 24 24", ...props },
    React__default.default.createElement("path", {
      d: "M8.99984 5.89661V6.27661C8.16984 5.94661 7.27984 5.77661 6.38984 5.77661C4.96985 5.77661 3.54985 6.20661 2.33985 7.06661C1.82985 7.42661 1.76985 8.15661 2.20985 8.59661L4.77985 11.1666H5.88984V12.2766C6.74984 13.1366 7.86984 13.5866 8.99984 13.6366V15.8966H6.99985C6.44984 15.8966 5.99985 16.3466 5.99985 16.8966V18.8966C5.99985 19.9966 6.89985 20.8966 7.99984 20.8966H17.9998C19.6598 20.8966 20.9998 19.5566 20.9998 17.8966V5.89661C20.9998 5.34661 20.5498 4.89661 19.9998 4.89661H9.99984C9.44984 4.89661 8.99984 5.34661 8.99984 5.89661ZM7.88984 11.3066V9.15661H5.60984L4.56985 8.11661C5.13985 7.89661 5.75985 7.77661 6.38984 7.77661C7.72984 7.77661 8.97985 8.29661 9.92984 9.23661L11.3398 10.6466L11.1398 10.8466C10.6298 11.3566 9.94984 11.6466 9.21984 11.6466C8.74985 11.6466 8.28984 11.5266 7.88984 11.3066ZM18.9998 17.8966C18.9998 18.4466 18.5498 18.8966 17.9998 18.8966C17.4498 18.8966 16.9998 18.4466 16.9998 17.8966V16.8966C16.9998 16.3466 16.5498 15.8966 15.9998 15.8966H10.9998V13.3066C11.5698 13.0766 12.0998 12.7366 12.5598 12.2766L12.7598 12.0766L15.5898 14.8966H16.9998V13.4866L10.9998 7.51661V6.89661H18.9998V17.8966Z",
    })
  );
};

const Icon$W = function (props) {
  return React__default.default.createElement(
    Svg,
    { viewBox: "0 0 20 20", ...props },
    React__default.default.createElement("path", {
...
const Icon$U = function (props) {
  return React__default.default.createElement(
    Svg,
    { viewBox: "0 0 34 38", ...props },
    React__default.default.createElement("rect", {
      x: "8.83594",
      width: "5.30132",
      height: "17.3191",
...
const Icon$S = function (props) {
  const id = lodash.uniqueId("svg");
  return React__default.default.createElement(
    Svg,
    { viewBox: "0 0 64 64", ...props },
    React__default.default.createElement(
      ...
      React__default.default.createElement(
        ...
        React__default.default.createElement("path", {
          d: "M36.1074 37.606L30.6528 39.0675L35.3736 56.686L40.8283 55.2244L36.1074 37.606Z",
          fill: "#7A6EAA",
        }),
        React__default.default.createElement("path", {
          d: "M17.9272 46.1213L19.5837 52.3033L52.3115 43.5339L50.6551 37.3519L17.9272 46.1213Z",
          fill: "#7A6EAA",
        }),
        React__default.default.createElement("path", {
          fillRule: "evenodd",
        ...
        React__default.default.createElement("path", {
          d: "M33.2085 26.7876L27.7539 28.2492L30.6526 39.0675L36.1073 37.606L33.2085 26.7876Z",
          fill: "#7A6EAA",
        }),
        React__default.default.createElement("path", {
...
const Icon$R = function (props) {
  ...
  return React__default.default.createElement(
    ...
    React__default.default.createElement(
      ...
      React__default.default.createElement("path", {
        d: "M35.2297 28.8525L27.1932 31.0059L34.3987 57.8973L42.4352 55.7439L35.2297 28.8525Z",
        fill: "#7645D9",
      }),
      React__default.default.createElement("path", {
        d: "M54.5173 42.4023L52.3639 34.3658L15.1113 44.3476L17.2647 52.3841L54.5173 42.4023Z",
        fill: "#7645D9",
      }),
      React__default.default.createElement(
        "g",
      ...
      React__default.default.createElement("path", {
        d: "M38.8242 16.6804L30.7877 14.527L27.8889 25.3454L35.9254 27.4988L38.8242 16.6804Z",
        fill: "#7645D9",
      }),
      React__default.default.createElement(
        "g",
  ...
  return React__default.default.createElement(
    ...
    React__default.default.createElement(
      ...
      React__default.default.createElement(
        ...
        React__default.default.createElement("path", {
          d: "M34.8555 33.9338L29.6231 33.9338L29.6231 49.4886L34.8555 49.4886L34.8555 33.9338Z",
          fill: "#BDC2C4",
        }),
        React__default.default.createElement("path", {
          d: "M16.5422 36.9358L16.5422 42.3936L47.9363 42.3936L47.9363 36.9358L16.5422 36.9358Z",
          fill: "#BDC2C4",
        }),
        React__default.default.createElement("path", {
          fillRule: "evenodd",
        ...
        React__default.default.createElement("path", {
          d: "M34.8555 24.3828L29.6231 24.3828L29.6231 33.934L34.8555 33.934L34.8555 24.3828Z",
          fill: "#BDC2C4",
        })
      ),
      React__default.default.createElement("path", {
...
const Icon$O = function (props) {
  return React__default.default.createElement(
    Svg,
    { viewBox: "0 0 18 16", ...props },
    React__default.default.createElement("path", {
      d: "M10.0002 7.33L15.0002 14H3.00018L8.00018 7.33V2H10.0002V7.33ZM12.9602 0H5.04018C4.62018 0 4.39018 0.48 4.65018 0.81L6.00018 2.5V6.67L0.200175 14.4C-0.289825 15.06 0.180175 16 1.00018 16H17.0002C17.8202 16 18.2902 15.06 17.8002 14.4L12.0002 6.67V2.5L13.3502 0.81C13.6102 0.48 13.3802 0 12.9602 0Z",
    })
  );
};

const Icon$N = function (props) {
  return React__default.default.createElement(
    Svg,
...
const Icon$M = function (props) {
  return React__default.default.createElement(
    ...
    React__default.default.createElement("circle", {
      ...
      cy: "24",
      r: "24",
      fill: "url(#paint0_linear_ticketround)",
    }),
    React__default.default.createElement("path", {
    ...
    React__default.default.createElement(
      ...
      React__default.default.createElement(
        "linearGradient",
        { id: "paint0_linear_ticketround", x1: "24", y1: "0", x2: "24", y2: "48", gradientUnits: "userSpaceOnUse" },
        React__default.default.createElement("stop", { stopColor: "#54DADE" }),
        React__default.default.createElement("stop", { offset: "0.762157", stopColor: "#24C7D6" })
      )
    )
...
const ExpandableButton = function (_a) {
  const { onClick } = _a;
  const { expanded } = _a;
  const { children } = _a;
  return React__default.default.createElement(
    IconButton,
    { "aria-label": "Hide or show expandable content", onClick },
    children,
    expanded
      ? React__default.default.createElement(Icon$1o, { color: "invertedContrast" })
      : React__default.default.createElement(Icon$1r, { color: "invertedContrast" })
  );
};
ExpandableButton.defaultProps = {
  expanded: false,
};
const ExpandableLabel = function (_a) {
  const { onClick } = _a;
  const { expanded } = _a;
  const { children } = _a;
  return React__default.default.createElement(
...
const Box = styled__default.default.div(
  templateObject_1$R ||
    (templateObject_1$R = __makeTemplateObject(
      ["\n  ", "\n  ", "\n  ", "\n  ", "\n  ", "\n"],
      ["\n  ", "\n  ", "\n  ", "\n  ", "\n  ", "\n"]
    )),
...
let templateObject_1$R;

const Flex = styled__default.default(Box)(
  templateObject_1$Q ||
    (templateObject_1$Q = __makeTemplateObject(["\n  display: flex;\n  ", "\n"], ["\n  display: flex;\n  ", "\n"])),
  styledSystem.flexbox
);
let templateObject_1$Q;
...
const getThemeColor = function (_a) {
  const { theme } = _a;
  const _b = _a.variant;
  const variant = _b === void 0 ? variants$3.INFO : _b;
  switch (variant) {
...
const getIcon = function (variant) {
  if (variant === void 0) {
    variant = variants$3.INFO;
  }
  switch (variant) {
    case variants$3.DANGER:
      return Icon$1O;
...
const IconLabel = styled__default.default.div(
  templateObject_1$P ||
    (templateObject_1$P = __makeTemplateObject(
...
const Details = styled__default.default.div(
  templateObject_2$l ||
    (templateObject_2$l = __makeTemplateObject(
      ["\n  flex: 1;\n  padding-bottom: 12px;\n  padding-left: 12px;\n  padding-right: ", ";\n  padding-top: 12px;\n"],
      ["\n  flex: 1;\n  padding-bottom: 12px;\n  padding-left: 12px;\n  padding-right: ", ";\n  padding-top: 12px;\n"]
    )),
  function (_a) {
...
const CloseHandler = styled__default.default.div(
  templateObject_3$a ||
    (templateObject_3$a = __makeTemplateObject(
...
const StyledAlert = styled__default.default(Flex)(
  templateObject_4$7 ||
    (templateObject_4$7 = __makeTemplateObject(
      [
        "\n  position: relative;\n  background-color: ",
...
const Alert = function (_a) {
  ...
  return React__default.default.createElement(
    ...
    React__default.default.createElement(
      IconLabel,
      { variant, hasDescription: !!children },
    ...
    onClick &&
      React__default.default.createElement(
        ...
        React__default.default.createElement(
          IconButton,
          { scale: "sm", variant: "text", onClick },
          React__default.default.createElement(Icon$1n, { width: "24px", color: "currentColor" })
        )
      )
  );
};
let templateObject_1$P;
let templateObject_2$l;
let templateObject_3$a;
let templateObject_4$7;
 ...
 */
const getBoxShadow$1 = function (_a) {
  const _b = _a.isSuccess;
  const isSuccess = _b === void 0 ? false : _b;
  const _c = _a.isWarning;
  const isWarning = _c === void 0 ? false : _c;
  const { theme } = _a;
  if (isWarning) {
...
const getHeight = function (_a) {
  const _b = _a.scale;
  const scale = _b === void 0 ? scales$7.MD : _b;
  switch (scale) {
    case scales$7.SM:
      return "32px";
    case scales$7.LG:
...
const Input$1 = styled__default.default.input(
  templateObject_1$O ||
    (templateObject_1$O = __makeTemplateObject(
      [
        "\n  background-color: ",
        ";\n  border: 0;\n  border-radius: 16px;\n  box-shadow: ",
        ";\n  color: ",
...
let templateObject_1$O;

const StyledBalanceInput = styled__default.default(Box)(
  templateObject_1$N ||
    (templateObject_1$N = __makeTemplateObject(
      [
        "\n  background-color: ",
        ";\n  border: 1px solid ",
        ";\n  border-radius: 16px;\n  box-shadow: ",
...
const StyledInput$1 = styled__default.default(Input$1)(
  templateObject_2$k ||
    (templateObject_2$k = __makeTemplateObject(
      [
...
let templateObject_1$N;
let templateObject_2$k;

const BalanceInput = function (_a) {
  const { value } = _a;
  const _b = _a.placeholder;
  const placeholder = _b === void 0 ? "0.0" : _b;
  const { onUserInput } = _a;
  const { currencyValue } = _a;
  const { inputProps } = _a;
  const { innerRef } = _a;
  const _c = _a.isWarning;
  const isWarning = _c === void 0 ? false : _c;
  const _d = _a.decimals;
  const decimals = _d === void 0 ? 18 : _d;
  const props = __rest(_a, [
    "value",
    "placeholder",
    "onUserInput",
  ...
  return React__default.default.createElement(
    ...
    currencyValue &&
      React__default.default.createElement(
        Text,
        { fontSize: "12px", textAlign: "right", color: "textSubtle" },
        currencyValue
      )
  );
};
...
const Grid = styled__default.default(Box)(
  templateObject_1$M ||
    (templateObject_1$M = __makeTemplateObject(
      ["\n  display: grid;\n  ", "\n  ", "\n"],
      ["\n  display: grid;\n  ", "\n  ", "\n"]
    )),
  styledSystem.flexbox,
...
let templateObject_1$M;

const Separator = styled__default.default.div(
  templateObject_1$L ||
    (templateObject_1$L = __makeTemplateObject(
      [
        "\n  align-items: center;\n  color: ",
        ";\n  display: flex;\n  justify-content: center;\n  padding-left: 4px;\n  padding-right: 4px;\n\n  ",
        " {\n    padding-left: 8px;\n    padding-right: 8px;\n  }\n\n  ",
...
const StyledBreadcrumbs = styled__default.default.ul(
  templateObject_2$j ||
    (templateObject_2$j = __makeTemplateObject(
      ["\n  align-items: center;\n  display: flex;\n  flex-wrap: wrap;\n  list-style-type: none;\n\n  ", "\n"],
      ["\n  align-items: center;\n  display: flex;\n  flex-wrap: wrap;\n  list-style-type: none;\n\n  ", "\n"]
    )),
  styledSystem.space
);
const insertSeparators = function (items, separator) {
...
const DefaultSeparator = React__default.default.createElement(Icon$1p, { color: "currentColor", width: "24px" });
const Breadcrumbs = function (_a) {
  const _b = _a.separator;
  const separator = _b === void 0 ? DefaultSeparator : _b;
  const { children } = _a;
  const validItems = React.Children.toArray(children).filter(function (child) {
  ...
  return React__default.default.createElement(
    ...
    items.map(function (item, index) {
      return React__default.default.createElement("li", { key: `child-${index}` }, item);
    })
  );
};
let templateObject_1$L;
let templateObject_2$j;

const getBackgroundColor = function (_a) {
  const { theme } = _a;
  const { variant } = _a;
  return theme.colors[variant === variants$5.SUBTLE ? "input" : "tertiary"];
};
const getBorderColor = function (_a) {
  const { theme } = _a;
  const { variant } = _a;
...
const StyledButtonMenu = styled__default.default.div(
  templateObject_1$K ||
    (templateObject_1$K = __makeTemplateObject(
      [
        "\n  background-color: ",
        ";\n  border-radius: 16px;\n  display: ",
        ";\n  border: 1px solid ",
  ...
  function (_a) {
    ...
    if (disabled) {
      return `\n        opacity: 0.5;\n\n        & > button:disabled {\n          background-color: transparent;\n          color: ${
        variant === variants$5.PRIMARY ? theme.colors.primary : theme.colors.textSubtle
      };\n        }\n    `;
    }
    return "";
  },
...
const ButtonMenu$1 = function (_a) {
  const _b = _a.activeIndex;
  const activeIndex = _b === void 0 ? 0 : _b;
  const _c = _a.scale;
  const scale = _c === void 0 ? scales$8.MD : _c;
  const _d = _a.variant;
  const variant = _d === void 0 ? variants$5.PRIMARY : _d;
  const { onItemClick } = _a;
  const { disabled } = _a;
  const { children } = _a;
  const _e = _a.fullWidth;
  const fullWidth = _e === void 0 ? false : _e;
  const props = __rest(_a, ["activeIndex", "scale", "variant", "onItemClick", "disabled", "children", "fullWidth"]);
  return React__default.default.createElement(
    StyledButtonMenu,
    { disabled, variant, fullWidth, ...props },
...
let templateObject_1$K;

const InactiveButton = styled__default.default(Button)(
  templateObject_1$J ||
    (templateObject_1$J = __makeTemplateObject(
      [
        "\n  background-color: transparent;\n  color: ",
...
const ButtonMenuItem = function (_a) {
  const _b = _a.isActive;
  const isActive = _b === void 0 ? false : _b;
  const _c = _a.variant;
  const variant = _c === void 0 ? variants$5.PRIMARY : _c;
  const { as } = _a;
  const props = __rest(_a, ["isActive", "variant", "as"]);
  if (!isActive) {
    return React__default.default.createElement(InactiveButton, { forwardedAs: as, variant, ...props });
  }
  return React__default.default.createElement(Button, { as, variant, ...props });
};
let templateObject_1$J;

/**
 * Priority: Warning --> Success --> Active
 */
const getBoxShadow = function (_a) {
  const { isActive } = _a;
  const { isSuccess } = _a;
  const { isWarning } = _a;
  const { theme } = _a;
...
const StyledCard = styled__default.default.div(
  templateObject_1$I ||
    (templateObject_1$I = __makeTemplateObject(
      [
        "\n  background-color: ",
        ";\n  border: ",
        ";\n  border-radius: ",
...
let templateObject_1$I;

const Card = function (_a) {
  const { ribbon } = _a;
  const { children } = _a;
  const props = __rest(_a, ["ribbon", "children"]);
  return React__default.default.createElement(StyledCard, { ...props }, ribbon, children);
};
...
let templateObject_1$H;

const CardHeader = styled__default.default.div(
  templateObject_1$G ||
    (templateObject_1$G = __makeTemplateObject(
      ["\n  background: ", ";\n  ", "\n"],
      ["\n  background: ", ";\n  ", "\n"]
    )),
  function (_a) {
    const { theme } = _a;
    const _b = _a.variant;
    const variant = _b === void 0 ? "default" : _b;
...
let templateObject_1$G;

const CardFooter = styled__default.default.div(
  templateObject_1$F ||
    (templateObject_1$F = __makeTemplateObject(
...
let templateObject_1$F;

const StyledCardRibbon = styled__default.default.div(
  templateObject_1$E ||
  ...
  function (_a) {
    const _b = _a.variantColor;
    const variantColor = _b === void 0 ? "secondary" : _b;
    const { theme } = _a;
    return theme.colors[variantColor];
  },
  function (_a) {
    const { ribbonPosition } = _a;
...
const CardRibbon = function (_a) {
  const { variantColor } = _a;
  const { text } = _a;
  const { ribbonPosition } = _a;
  const props = __rest(_a, ["variantColor", "text", "ribbonPosition"]);
  return React__default.default.createElement(
    StyledCardRibbon,
    { variantColor, ribbonPosition, ...props },
...
let templateObject_1$D;

const getLeft = function (_a) {
  const { position } = _a;
...
const Container$4 = styled__default.default.div(
  templateObject_2$i ||
    (templateObject_2$i = __makeTemplateObject(
      ["\n  position: relative;\n  &:hover ", ", &:focus-within ", " {\n    display: flex;\n  }\n"],
      ["\n  position: relative;\n  &:hover ", ", &:focus-within ", " {\n    display: flex;\n  }\n"]
    )),
  DropdownContent,
...
const Dropdown = function (_a) {
  const { target } = _a;
  const _b = _a.position;
  const position = _b === void 0 ? "bottom" : _b;
  const { children } = _a;
  return React__default.default.createElement(
    Container$4,
    null,
    target,
    React__default.default.createElement(DropdownContent, { position }, children)
  );
};
Dropdown.defaultProps = {
  position: "bottom",
};
let templateObject_1$C;
let templateObject_2$i;

const bunnyFall = styled.keyframes(
  templateObject_1$B ||
...
const Bunny = styled__default.default.div(
  templateObject_2$h ||
    (templateObject_2$h = __makeTemplateObject(
      [
        "\n  display: inline-flex;\n  position: fixed;\n  top: 0;\n  left: ",
...
const FallingBunnies = function (_a) {
  const _b = _a.count;
  const count = _b === void 0 ? 30 : _b;
  const _c = _a.size;
  const size = _c === void 0 ? 32 : _c;
  const _d = _a.iterations;
  const iterations = _d === void 0 ? Infinity : _d;
  const _e = _a.duration;
  const duration = _e === void 0 ? 10 : _e;
  const bunnies = __spreadArray([], Array(count)).map(function (_, index) {
    return React__default.default.createElement(
      Bunny,
      { key: String(index), position: Math.random() * 100, iterations, duration },
...
let templateObject_1$B;
let templateObject_2$h;
...
const style =
  ...
  _a$3);
const Heading = styled__default.default(Text).attrs({ bold: true })(
  templateObject_1$A ||
...
const StyledLink$1 = styled__default.default(Text)(
  templateObject_1$x ||
    (templateObject_1$x = __makeTemplateObject(
      [
...
const Link = function (_a) {
  const { external } = _a;
  const props = __rest(_a, ["external"]);
  const internalProps = external ? getExternalLinkProps() : {};
  return React__default.default.createElement(StyledLink$1, { as: "a", bold: true, ...internalProps, ...props });
};
Link.defaultProps = {
  color: "primary",
};
...
const LinkExternal = function (_a) {
  const { children } = _a;
...
const Message = function (_a) {
  const { children } = _a;
  const { variant } = _a;
  const props = __rest(_a, ["children", "variant"]);
  const Icon = Icons$3[variant];
  return React__default.default.createElement(
    MessageContainer,
    { variant, ...props },
    React__default.default.createElement(
...
const Dot = styled__default.default.span(
  templateObject_2$g ||
    (templateObject_2$g = __makeTemplateObject(
      [
        "\n  display: ",
        ";\n  position: absolute;\n  top: 0;\n  right: 0;\n  width: 10px;\n  height: 10px;\n  pointer-events: none;\n  border: 2px solid ",
        ";\n  border-radius: 50%;\n  background-color: ",
...
const NotificationDot = function (_a) {
  const _b = _a.show;
  const show = _b === void 0 ? false : _b;
  const { children } = _a;
  const props = __rest(_a, ["show", "children"]);
  return React__default.default.createElement(
    NotificationDotRoot,
    null,
    ...
    React__default.default.createElement(Dot, { show })
  );
};
let templateObject_1$v;
let templateObject_2$g;

const Overlay = styled__default.default.div.attrs({ role: "presentation" })(
  templateObject_1$u ||
    (templateObject_1$u = __makeTemplateObject(
      [
        "\n  position: fixed;\n  top: 0px;\n  left: 0px;\n  width: 100%;\n  height: 100%;\n  background-color: ",
...
const getScale$2 = function (property) {
  return function (_a) {
    const _b = _a.scale;
    const scale = _b === void 0 ? scales$4.MD : _b;
    return scaleKeyValues$1[scale][property];
  };
};
const PancakeStack = styled__default.default.div(
  templateObject_1$t ||
    (templateObject_1$t = __makeTemplateObject(
      [
  ...
  getScale$2("pancakeSize"),
  getScale$2("pancakeSize"),
  getScale$2("pancakeThickness"),
  getScale$2("pancakeThickness"),
  function (_a) {
    const { theme } = _a;
  ...
  getScale$2("pancakeTwoOffset"),
  getScale$2("pancakeThreeOffset"),
  getScale$2("butterSmearOneTop"),
  getScale$2("butterSmearOneLeft"),
  getScale$2("butterSmearTwoTop"),
  getScale$2("butterSmearTwoRight"),
  getScale$2("butterWidth"),
  getScale$2("butterHeight"),
  getScale$2("butterTop"),
  getScale$2("butterLeft"),
  getScale$2("butterRadius"),
  getScale$2("butterThickness"),
  getScale$2("butterThickness")
);
const PancakeInput = styled__default.default.input(
  templateObject_2$f ||
    (templateObject_2$f = __makeTemplateObject(
      [
        "\n  height: 40px;\n  left: 0;\n  opacity: 0;\n  position: absolute;\n  top: 0;\n  width: 40px;\n\n  &:focus + label {\n    box-shadow: ",
  ...
  getScale$2("travelDistance"),
  getScale$2("pancakeThickness"),
  getScale$2("pancakeThickness")
);
const PancakeLabel = styled__default.default.label(
  templateObject_3$9 ||
    (templateObject_3$9 = __makeTemplateObject(
      [
        "\n  width: ",
        ";\n  height: ",
        ";\n  background: ",
  ...
  getScale$2("toggleWidth"),
  getScale$2("toggleHeight"),
  function (_a) {
    const { theme } = _a;
    const { checked } = _a;
...
let templateObject_1$t;
let templateObject_2$f;
let templateObject_3$9;

const PancakeToggle = function (_a) {
  const { checked } = _a;
  const _b = _a.scale;
  const scale = _b === void 0 ? scales$4.MD : _b;
  const props = __rest(_a, ["checked", "scale"]);
  return React__default.default.createElement(
    PancakeStack,
    { scale },
    React__default.default.createElement(PancakeInput, {
    ...
    React__default.default.createElement(
      PancakeLabel,
      { scale, checked, htmlFor: props.id || "pancake-toggle" },
      React__default.default.createElement(
        "div",
        { className: "pancakes" },
...
const StyledProgress = styled__default.default.div(
  templateObject_2$e ||
    (templateObject_2$e = __makeTemplateObject(
      [
        "\n  position: relative;\n  background-color: ",
        ";\n  box-shadow: ",
        ";\n  overflow: hidden;\n\n  ",
...
let templateObject_1$s;
let templateObject_2$e;

const ProgressBunnyWrapper = styled__default.default.div(
  templateObject_1$r ||
    (templateObject_1$r = __makeTemplateObject(
      [
...
const Progress = function (_a) {
  const _b = _a.variant;
  const variant = _b === void 0 ? variants$1.ROUND : _b;
  const _c = _a.scale;
  const scale = _c === void 0 ? scales$3.MD : _c;
  const _d = _a.primaryStep;
  const primaryStep = _d === void 0 ? 0 : _d;
  const _e = _a.secondaryStep;
  const secondaryStep = _e === void 0 ? null : _e;
  const _f = _a.showProgressBunny;
  const showProgressBunny = _f === void 0 ? false : _f;
  return React__default.default.createElement(
    StyledProgress,
    { variant, scale },
    showProgressBunny &&
    ...
    secondaryStep
      ? React__default.default.createElement(Bar, { style: { width: `${stepGuard(secondaryStep)}%` } })
      : null
  );
};
...
const getCheckedScale = function (_a) {
  const { scale } = _a;
  switch (scale) {
    case scales$2.SM:
      return "12px";
...
const Radio = styled__default.default.input.attrs({ type: "radio" })(
  templateObject_1$q ||
    (templateObject_1$q = __makeTemplateObject(
      [
        "\n  appearance: none;\n  overflow: hidden;\n  cursor: pointer;\n  position: relative;\n  display: inline-block;\n  height: ",
...
const bunnyHeadMain =
  "data:image/svg+xml,%3Csvg%20width%3D%2224%22%20height%3D%2224%22%20viewBox%3D%220%200%2024%2024%22%20fill%3D%22none%22%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%3E%20%20%3Ccircle%20cx%3D%2212%22%20cy%3D%2212%22%20r%3D%2212%22%20fill%3D%22%23FE5A06%22%20%2F%3E%20%20%3Ccircle%20cx%3D%2212%22%20cy%3D%2212%22%20r%3D%228%22%20fill%3D%22%23FD7508%22%20%2F%3E%20%20%3Ccircle%20cx%3D%2212%22%20cy%3D%2212%22%20r%3D%224%22%20fill%3D%22%23FEA401%22%20%2F%3E%3C%2Fsvg%3E";
...
const getCursorStyle = function (_a) {
  const _b = _a.disabled;
  const disabled = _b === void 0 ? false : _b;
  return disabled ? "not-allowed" : "cursor";
};
const getBaseThumbStyles = function (_a) {
  const { isMax } = _a;
  const { disabled } = _a;
  return `\n  -webkit-appearance: none;\n  background-image: url(${
    isMax ? bunnyHeadMain : bunnyHeadMain
  });\n  background-color: transparent;\n  border: 0;\n  cursor: ${getCursorStyle};\n  width: 24px;\n  height: 24px;\n  filter: ${
    disabled ? "grayscale(100%)" : "none"
  };\n  top: -12px;\n  left: -12px;\n  \n`;
};
const SliderLabelContainer = styled__default.default.div(
  templateObject_1$p ||
    (templateObject_1$p = __makeTemplateObject(
      ["\n  bottom: 0;\n  position: absolute;\n  width: calc(100%);\n"],
      ["\n  bottom: 0;\n  position: absolute;\n  width: calc(100%);\n"]
...
const SliderLabel = styled__default.default(Text)(
  templateObject_2$d ||
    (templateObject_2$d = __makeTemplateObject(
      [
        "\n  bottom: 0;\n  font-size: 12px;\n  left: ",
...
styled__default.default.div(
  templateObject_3$8 ||
    (templateObject_3$8 = __makeTemplateObject(
      [
        "\n  background: url(",
        ") no-repeat;\n  height: 32px;\n  filter: ",
        ";\n  position: absolute;\n  width: 15px;\n",
...
const BunnySlider = styled__default.default.div(
  templateObject_4$6 ||
    (templateObject_4$6 = __makeTemplateObject(
      ["\n  position: absolute;\n  /* left: 14px; */\n  width: calc(100%);\n"],
      ["\n  position: absolute;\n  /* left: 14px; */\n  width: calc(100%);\n"]
    ))
);
const StyledInput = styled__default.default.input(
  templateObject_5$5 ||
    (templateObject_5$5 = __makeTemplateObject(
      [
        "\n  cursor: ",
        ";\n  height: 32px;\n  position: relative;\n\n  ::-webkit-slider-thumb {\n    ",
        "\n  }\n\n  ::-moz-range-thumb {\n    ",
...
const BarBackground = styled__default.default.div(
  templateObject_6$2 ||
    (templateObject_6$2 = __makeTemplateObject(
      [
        "\n  background-color: ",
        ";\n  height: 2px;\n  position: absolute;\n  top: 18px;\n  left: 4px;\n  width: calc(100% - 8px);\n",
      ],
...
let templateObject_1$p;
let templateObject_2$d;
let templateObject_3$8;
let templateObject_4$6;
let templateObject_5$5;
let templateObject_6$2;
let templateObject_7$1;

const Slider = function (_a) {
  const { name } = _a;
  const { min } = _a;
  const { max } = _a;
  const { value } = _a;
  const { onValueChanged } = _a;
  const { valueLabel } = _a;
  const _b = _a.step;
  const step = _b === void 0 ? "any" : _b;
  const _c = _a.disabled;
  const disabled = _c === void 0 ? false : _c;
  const props = __rest(_a, ["name", "min", "max", "value", "onValueChanged", "valueLabel", "step", "disabled"]);
  const handleChange = function (_a) {
    const { target } = _a;
  ...
  return React__default.default.createElement(
    Box,
    { position: "relative", height: "48px", ...props },
    React__default.default.createElement(
      BunnySlider,
      null,
      React__default.default.createElement(BarBackground, { disabled }),
      React__default.default.createElement(BarProgress, { style: { width: progressWidth }, disabled }),
...
const pulse = styled.keyframes(
  templateObject_2$c ||
    (templateObject_2$c = __makeTemplateObject(
      ["\n  0% {\n    opacity: 1;\n  }\n  50% {\n    opacity: 0.4;\n  }\n  100% {\n    opacity: 1;\n  }\n"],
      ["\n  0% {\n    opacity: 1;\n  }\n  50% {\n    opacity: 0.4;\n  }\n  100% {\n    opacity: 1;\n  }\n"]
    ))
);
const Root = styled__default.default.div(
  templateObject_3$7 ||
    (templateObject_3$7 = __makeTemplateObject(
      [
        "\n  min-height: 20px;\n  display: block;\n  background-color: ",
        ";\n  border-radius: ",
        ";\n\n  ",
...
const Pulse = styled__default.default(Root)(
  templateObject_4$5 ||
    (templateObject_4$5 = __makeTemplateObject(
...
const Waves = styled__default.default(Root)(
  templateObject_5$4 ||
    (templateObject_5$4 = __makeTemplateObject(
      [
...
const Skeleton = function (_a) {
  const _b = _a.variant;
  const variant$1 = _b === void 0 ? variant.RECT : _b;
  const _c = _a.animation;
  const animation$1 = _c === void 0 ? animation.PULSE : _c;
  const props = __rest(_a, ["variant", "animation"]);
  if (animation$1 === animation.WAVES) {
    return React__default.default.createElement(Waves, { variant: variant$1, ...props });
  }
  return React__default.default.createElement(Pulse, { variant: variant$1, ...props });
};
let templateObject_1$o;
let templateObject_2$c;
let templateObject_3$7;
let templateObject_4$5;
let templateObject_5$4;
...
const float = styled.keyframes(
  templateObject_2$b ||
    (templateObject_2$b = __makeTemplateObject(
      [
...
const Container$3 = styled__default.default.div(
  templateObject_3$6 ||
    (templateObject_3$6 = __makeTemplateObject(["\n  position: relative;\n"], ["\n  position: relative;\n"]))
);
const RotatingPancakeIcon = styled__default.default(Icon$s)(
  templateObject_4$4 ||
    (templateObject_4$4 = __makeTemplateObject(
      [
        "\n  position: absolute;\n  top: 0;\n  left: 0;\n  animation: ",
        " 2s linear infinite;\n  transform: translate3d(0, 0, 0);\n",
      ],
...
const FloatingPanIcon = styled__default.default(Icon$t)(
  templateObject_5$3 ||
    (templateObject_5$3 = __makeTemplateObject(
      ["\n  animation: ", " 6s ease-in-out infinite;\n  transform: translate3d(0, 0, 0);\n"],
      ["\n  animation: ", " 6s ease-in-out infinite;\n  transform: translate3d(0, 0, 0);\n"]
    )),
  float
);
const Spinner = function (_a) {
  const _b = _a.size;
  const size = _b === void 0 ? 128 : _b;
  return React__default.default.createElement(
    Container$3,
    null,
...
let templateObject_1$n;
let templateObject_2$b;
let templateObject_3$6;
let templateObject_4$4;
let templateObject_5$3;
...
const Stepper = function (_a) {
  const { children } = _a;
  const numberOfSteps = React__default.default.Children.count(children);
  return React__default.default.createElement(
    StepperWrapper,
    null,
    React__default.default.Children.map(children, function (child) {
      if (React__default.default.isValidElement(child)) {
        return React__default.default.cloneElement(child, { numberOfSteps });
      }
      return child;
    })
  );
...
const getStepNumberFontColor = function (_a) {
  const { theme } = _a;
  const { status } = _a;
  if (status === "past") {
    return theme.colors.success;
...
const StyledStep = styled__default.default(Flex)(
  templateObject_1$l ||
    (templateObject_1$l = __makeTemplateObject(
      ["\n  ", " {\n    justify-content: center;\n  }\n"],
      ["\n  ", " {\n    justify-content: center;\n  }\n"]
...
const Connector = styled__default.default.div(
  templateObject_2$a ||
    (templateObject_2$a = __makeTemplateObject(
      [
        "\n  position: absolute;\n  width: 4px;\n  height: 110%;\n  top: 50%;\n  left: calc(50% - 2px);\n  background-color: ",
        ";\n",
      ],
...
const ChildrenWrapper = styled__default.default(Box)(
  templateObject_3$5 ||
...
const ChildrenLeftWrapper = styled__default.default(ChildrenWrapper)(
  templateObject_4$3 ||
...
const ChildrenRightWrapper = styled__default.default(ChildrenWrapper)(
  templateObject_5$2 ||
...
const StepNumber = styled__default.default.div(
  templateObject_7 ||
 ...
 */
const Step = function (_a) {
  const { index } = _a;
  const { status } = _a;
  const _b = _a.numberOfSteps;
  const numberOfSteps = _b === void 0 ? 0 : _b;
  const { children } = _a;
  const isIndexPair = index % 2 === 0;
  return React__default.default.createElement(
    StyledStep,
    { mb: index < numberOfSteps - 1 ? "16px" : 0 },
    React__default.default.createElement(ChildrenLeftWrapper, { isVisible: !isIndexPair }, children),
    React__default.default.createElement(
      Wrapper$2,
      null,
      React__default.default.createElement(StepNumber, { status }, index + 1),
      index < numberOfSteps - 1 && React__default.default.createElement(Connector, { status })
    ),
    React__default.default.createElement(ChildrenRightWrapper, { isVisible: isIndexPair }, children)
  );
};
let templateObject_1$l;
let templateObject_2$a;
let templateObject_3$5;
let templateObject_4$3;
let templateObject_5$2;
let templateObject_6$1;
let templateObject_7;

const byTextAscending = function (getTextProperty) {
...
const byTextDescending = function (getTextProperty) {
  return function (objectA, objectB) {
    const upperA = getTextProperty(objectA).toUpperCase();
    const upperB = getTextProperty(objectB).toUpperCase();
    if (upperA > upperB) {
...
const sortByColumn = function (data, sortColumn, columns) {
  let isAscending = null;
  let sortedRows = __spreadArray([], data);
    ...
    if (sortColumn === column.name) {
      ...
      if (column.sort) {
        ...
        sortedRows = isAscending
          ? data.sort(
              byTextAscending(function (object) {
                return object.original[sortColumn];
              })
            )
          : data.sort(
              byTextDescending(function (object) {
                return object.original[sortColumn];
              })
            );
      }
...
const getPaginatedData = function (rows, perPage, page) {
  const start = (page - 1) * perPage;
  const end = start + perPage;
  return rows.slice(start, end);
};
const getColumnsByName = function (columns) {
  const columnsByName = {};
  columns.forEach(function (column) {
    const col = {
      name: column.name,
  ...
  return function (state, action) {
    ...
    switch (action.type) {
      case "SET_ROWS":
        ...
        return { ...state, rows, originalRows: action.data, columns: columnCopy };
      case "NEXT_PAGE":
...
const sortDataInOrder = function (data, columns) {
...
const makeHeaderRender = function (label, render) {
  return render
    ? function () {
        return render({ label });
      }
...
const useTable = function (columns, data, options) {
  ...
  const tableData = React.useMemo(
    function () {
      ...
      const newData = sortedData.map(function (row, idx) {
        return {
          id: idx,
          selected: false,
          hidden: false,
  ...
  const _a = React.useReducer(reducer, {
  ...
  const state = _a[0];
  const dispatch = _a[1];
  state.pagination.nextPage = React.useCallback(
    function () {
      dispatch({ type: "NEXT_PAGE" });
    },
    [dispatch]
  );
  state.pagination.prevPage = React.useCallback(
    function () {
    ...
    function () {
      return __spreadArray(
        ...
        state.columns.map(function (column) {
          ...
          return { ...column, render: makeHeaderRender(label, column.headerRender) };
        })
      );
    },
    [state.columns]
  ...
  return {
    ...
    dispatch,
    selectRow(rowId) {
      return dispatch({ type: "SELECT_ROW", rowId });
    },
    toggleAll() {
      return dispatch({ type: "TOGGLE_ALL" });
    },
    toggleSort(columnName, isAscOverride) {
      return dispatch({ type: "TOGGLE_SORT", columnName, isAscOverride });
    },
    setSearchString(searchString) {
      return dispatch({ type: "SEARCH_STRING", searchString });
    },
...
const Wrapper$1 = styled__default.default(Flex)(
  templateObject_1$k ||
    (templateObject_1$k = __makeTemplateObject(
      [
        "\n  border-bottom: 2px solid ",
...
const Inner$1 = styled__default.default(Flex)(
  templateObject_2$9 ||
...
let templateObject_1$k;
let templateObject_2$9;

const getBorderRadius = function (_a) {
  const { scale } = _a;
  return scale === "md" ? "16px 16px 0 0" : "24px 24px 0 0";
};
const getPadding = function (_a) {
  const { scale } = _a;
...
const getOutlineStyles = function (_a) {
  const { outline } = _a;
  const { theme } = _a;
  const _b = _a.variant;
  const variantKey = _b === void 0 ? variants.PRIMARY : _b;
  if (outline) {
...
const Tag = function (_a) {
  ...
  const { endIcon } = _a;
  const { children } = _a;
  const props = __rest(_a, ["startIcon", "endIcon", "children"]);
  return React__default.default.createElement(
    StyledTag,
    { ...props },
...
const getScale = function (property) {
  return function (_a) {
    const _b = _a.scale;
    const scale = _b === void 0 ? scales$6.MD : _b;
    return scaleKeyValues[scale][property];
  };
};
const Handle = styled__default.default.div(
  templateObject_1$h ||
    (templateObject_1$h = __makeTemplateObject(
      [
        "\n  background-color: ",
        ";\n  border-radius: 50%;\n  cursor: pointer;\n  height: ",
        ";\n  left: ",
  ...
  getScale("handleHeight"),
  getScale("handleLeft"),
  getScale("handleTop"),
  getScale("handleWidth")
);
...
const StyledToggle = styled__default.default.div(
  ...
  getScale("toggleHeight"),
  getScale("toggleWidth")
);
let templateObject_1$h;
let templateObject_2$8;
let templateObject_3$4;
...
const Toggle = function (_a) {
  const { checked } = _a;
  const _b = _a.scale;
  const scale = _b === void 0 ? scales.MD : _b;
  const props = __rest(_a, ["checked", "scale"]);
  const isChecked = !!checked;
  return React__default.default.createElement(
    StyledToggle,
    { checked: isChecked, scale },
    React__default.default.createElement(Input, { checked, scale, ...props, type: "checkbox" }),
    React__default.default.createElement(Handle, { scale })
  );
};
Toggle.defaultProps = {
  scale: scales.MD,
...
const breakpoints = Object.values(breakpointMap).map(function (breakpoint) {
...
const shadows = {
  ...
  success: "0px 0px 0px 1px #f47107, 0px 0px 0px 4px rgba(49, 208, 170, 0.2)",
...
const mediaQueries = (function () {
  ...
  return Object.keys(breakpointMap).reduce(function (accum, size, index) {
    ...
    if (index === Object.keys(breakpointMap).length - 1) {
      return { ...accum, ...((_a = {}), (_a[size] = `(min-width: ${prevMinWidth}px)`), _a) };
    }
    const minWidth = prevMinWidth;
    const breakpoint = breakpointMap[size];
    // Min width for next iteration
    prevMinWidth = breakpoint + 1;
    return { ...accum, ...((_b = {}), (_b[size] = `(min-width: ${minWidth}px) and (max-width: ${breakpoint}px)`), _b) };
  }, {});
})();
const getKey = function (size) {
  return `is${size.charAt(0).toUpperCase()}${size.slice(1)}`;
};
const useMatchBreakpoints = function () {
  const _a = React.useState(function () {
    return Object.keys(mediaQueries).reduce(function (accum, size) {
      let _a;
      const key = getKey(size);
      const mql = window.matchMedia(mediaQueries[size]);
      return { ...accum, ...((_a = {}), (_a[key] = mql.matches), _a) };
    }, {});
  });
  const state = _a[0];
  const setState = _a[1];
  React.useEffect(
    function () {
      ...
      const handlers = Object.keys(mediaQueries).map(function (size) {
        const mql = window.matchMedia(mediaQueries[size]);
        const handler = function (matchMediaQuery) {
          const key = getKey(size);
          setState(function (prevState) {
            let _a;
            return { ...prevState, ...((_a = {}), (_a[key] = matchMediaQuery.matches), _a) };
          });
        };
        // Safari < 14 fix
...
const createParticle = function (x, y, imgSrc, options) {
  if (options === void 0) {
    options = {};
  }
  const _a = { ...defaultParticleOptions, ...options };
  const { size } = _a;
  const { distance } = _a;
 ...
 */
const useParticleBurst = function (options) {
  const _a = { ...defaultOptions, ...options };
  const { selector } = _a;
  const { numberOfParticles } = _a;
  const { debounceDuration } = _a;
  const { imgSrc } = _a;
  const { disableWhen } = _a;
  const { particleOptions } = _a;
  const makeListener = React.useCallback(
    function () {
      return debounce__default.default(
        function (event) {
          const isDisabled = disableWhen && disableWhen();
          if (!isDisabled) {
            const node = event.currentTarget;
            if (event.clientX === 0 && event.clientY === 0) {
              const _a = node.getBoundingClientRect();
              const { left } = _a;
              const { width } = _a;
              const top_1 = _a.top;
              const { height } = _a;
              const x = left + width / 2;
              const y = top_1 + height / 2;
...
const useKonamiCheatCode = function (matchedCodeHandler) {
  React.useEffect(
    function () {
      const pattern = [
        "ArrowUp",
      ...
      let currentIndex = 0;
      const onKeyUpHandler = function (event) {
        const { key } = event;
...
let templateObject_1$g;
let templateObject_2$7;

function isTouchDevice() {
  return "ontouchstart" in window || navigator.maxTouchPoints > 0 || navigator.msMaxTouchPoints > 0;
}
const invertTheme = function (currentTheme) {
...
const useTooltip = function (content, options) {
  const _a = options.placement;
  const placement = _a === void 0 ? "auto" : _a;
  const _b = options.trigger;
  const trigger = _b === void 0 ? "hover" : _b;
  const _c = options.arrowPadding;
  const arrowPadding = _c === void 0 ? 16 : _c;
  const _d = options.tooltipPadding;
  const tooltipPadding = _d === void 0 ? { left: 16, right: 16 } : _d;
  const _e = options.tooltipOffset;
  const tooltipOffset = _e === void 0 ? [0, 10] : _e;
  const _f = React.useState(null);
  const targetElement = _f[0];
  const setTargetElement = _f[1];
  const _g = React.useState(null);
  const tooltipElement = _g[0];
  const setTooltipElement = _g[1];
  const _h = React.useState(null);
  const arrowElement = _h[0];
  const setArrowElement = _h[1];
  const _j = React.useState(false);
  const visible = _j[0];
  const setVisible = _j[1];
  ...
  React.useEffect(
    function () {
      ...
      const handleClickOutside = function (_a) {
        const { target } = _a;
  ...
  const _k = reactPopper.usePopper(targetElement, tooltipElement, {
    placement,
    modifiers: [
      {
        name: "arrow",
  ...
  const tooltip = React__default.default.createElement(
    StyledTooltip,
    { ref: setTooltipElement, style: styles.popper, ...attributes.popper },
  ...
  const tooltipInPortal = portalRoot ? reactDom.createPortal(tooltip, portalRoot) : null;
  return {
...
const ModalBody = styled__default.default(Flex)(
  templateObject_3$3 ||
...
const ModalCloseButton = function (_a) {
  const { onDismiss } = _a;
  return React__default.default.createElement(
    IconButton,
...
const ModalBackButton = function (_a) {
  const { onBack } = _a;
  return React__default.default.createElement(
    IconButton,
    { variant: "text", onClick: onBack, "area-label": "go back", mr: "8px" },
...
let templateObject_1$f;
let templateObject_2$6;
let templateObject_3$3;
let templateObject_4$2;
...
const Modal = function (_a) {
  ...
  const { onBack } = _a;
  const { children } = _a;
  const _b = _a.hideCloseButton;
  const hideCloseButton = _b === void 0 ? false : _b;
  const _c = _a.bodyPadding;
  const bodyPadding = _c === void 0 ? "24px" : _c;
  const _d = _a.headerBackground;
  const headerBackground = _d === void 0 ? "transparent" : _d;
  const _e = _a.minWidth;
  const minWidth = _e === void 0 ? "320px" : _e;
  const props = __rest(_a, [
    "title",
    "onDismiss",
    "onBack",
  ...
  return React__default.default.createElement(
    ...
    React__default.default.createElement(
      ...
      React__default.default.createElement(
        ModalTitle,
        null,
        onBack && React__default.default.createElement(ModalBackButton, { onBack }),
        React__default.default.createElement(Heading, null, title)
      ),
      !hideCloseButton && React__default.default.createElement(ModalCloseButton, { onDismiss })
    ),
...
const ModalProvider = function (_a) {
  const { children } = _a;
  const _b = React.useState(false);
  const isOpen = _b[0];
  const setIsOpen = _b[1];
  const _c = React.useState();
  const modalNode = _c[0];
  const setModalNode = _c[1];
  const _d = React.useState("");
  const nodeId = _d[0];
  const setNodeId = _d[1];
  const _e = React.useState(true);
  const closeOnOverlayClick = _e[0];
  const setCloseOnOverlayClick = _e[1];
  const handlePresent = function (node, newNodeId) {
    setModalNode(node);
    setIsOpen(true);
    setNodeId(newNodeId);
  };
  ...
  const handleOverlayDismiss = function () {
...
const useModal = function (modal, closeOnOverlayClick, updateOnPropsChange, modalId) {
  if (closeOnOverlayClick === void 0) {
    closeOnOverlayClick = true;
  }
  if (updateOnPropsChange === void 0) {
    updateOnPropsChange = false;
  }
  if (modalId === void 0) {
    modalId = "defaultNodeId";
  }
  const _a = React.useContext(Context);
  const { isOpen } = _a;
  const { nodeId } = _a;
  const { modalNode } = _a;
  const { setModalNode } = _a;
  const { onPresent } = _a;
  const { onDismiss } = _a;
  const { setCloseOnOverlayClick } = _a;
...
const Icon$k = function (props) {
  ...
  props.height;
  const { isDark } = props;
  const other = __rest(props, ["width", "height", "isDark"]);
  const logoByTheme = function () {
    return isDark ? "/images/mlm/biglogodark.png" : "/images/mlm/biglogo.png";
  };
  return React__default.default.createElement(Image, {
    src: logoByTheme(),
    width: 205,
...
const Icon$8 = function (props) {
  return React__default.default.createElement(
    Svg,
    { viewBox: "0 0 576 512", ...props },
    React__default.default.createElement("path", {
...
const IconModule = /* #__PURE__ */ Object.freeze({
  __proto__: null,
  FarmIcon: Icon$r,
  GroupsIcon: Icon$q,
...
const Logo = function (_a) {
  const { isPushed } = _a;
  const { togglePush } = _a;
  const { isDark } = _a;
  const { href } = _a;
  const isAbsoluteUrl = href.startsWith("http");
  const innerLogo = React__default.default.createElement(
    React__default.default.Fragment,
    null,
    React__default.default.createElement(Icon$1c, { className: "mobile-icon" }),
    React__default.default.createElement(Icon$k, { className: "desktop-icon", isDark })
  );
  return React__default.default.createElement(
    Flex,
    null,
    React__default.default.createElement(
      MenuButton,
      { "aria-label": "Toggle menu", onClick: togglePush, mr: "24px" },
      isPushed
        ? React__default.default.createElement(Icon$o, { width: "24px", color: "textSubtle" })
        : React__default.default.createElement(Icon$p, { width: "24px", color: "textSubtle" })
    ),
    isAbsoluteUrl
      ? React__default.default.createElement(
          StyledLink,
          { as: "a", href, "aria-label": "Pancake home page" },
          innerLogo
        )
      : React__default.default.createElement(StyledLink, { to: href, "aria-label": "Pancake home page" }, innerLogo)
  );
};
const Logo$1 = React__default.default.memo(Logo, function (prev, next) {
  return prev.isPushed === next.isPushed && prev.isDark === next.isDark;
});
let templateObject_1$c;
let templateObject_2$5;
...
const rainbowAnimation = styled.keyframes(
  templateObject_1$b ||
    (templateObject_1$b = __makeTemplateObject(
...
const LinkLabel = styled__default.default.div(
  templateObject_2$4 ||
...
const DisabledLinkLabel = styled__default.default.div(
  templateObject_3$2 ||
  ...
  function (_a) {
    const { isPushed } = _a;
    const { theme } = _a;
    return isPushed ? theme.colors.textDisabled : "transparent";
  }
);
const MenuEntry = styled__default.default.div(
  templateObject_4$1 ||
...
const DisabledMenuEntry = styled__default.default.div(
  templateObject_5$1 ||
...
DisabledMenuEntry.defaultProps = {
  secondary: false,
  isActive: false,
  isDisabled: false,
};
const LinkStatus = styled__default.default(Text)(
  templateObject_6 ||
...
const LinkLabelMemo = React__default.default.memo(LinkLabel, function (prev, next) {
  return prev.isPushed === next.isPushed;
});
const DisabledLinkLabelMemo = React__default.default.memo(DisabledLinkLabel, function (prev, next) {
  return prev.isPushed === next.isPushed;
});
let templateObject_1$b;
let templateObject_2$4;
let templateObject_3$2;
let templateObject_4$1;
let templateObject_5$1;
...
const Accordion = function (_a) {
  const { label } = _a;
  const { status } = _a;
  const { icon } = _a;
  const { isPushed } = _a;
  const { pushNav } = _a;
  const _b = _a.initialOpenState;
  const initialOpenState = _b === void 0 ? false : _b;
  const { children } = _a;
  const { className } = _a;
  const { isActive } = _a;
  const _c = React.useState(initialOpenState);
  const isOpen = _c[0];
  const setIsOpen = _c[1];
  ...
  return React__default.default.createElement(
    ...
    React__default.default.createElement(
      MenuEntry,
      { onClick: handleClick, className, isActive, role: "button" },
      icon,
      React__default.default.createElement(LinkLabelMemo, { isPushed }, label),
      status &&
        React__default.default.createElement(LinkStatus, { color: status.color, fontSize: "14px" }, status.text),
      isOpen ? React__default.default.createElement(Icon$1I, null) : React__default.default.createElement(Icon$1J, null)
    ),
    React__default.default.createElement(
      AccordionContent,
      { isOpen, isPushed, maxHeight: React__default.default.Children.count(children) * MENU_ENTRY_HEIGHT },
      children
    )
  );
};
let templateObject_1$a;
let templateObject_2$3;

const MenuLink = function (_a) {
  const { href } = _a;
  const otherProps = __rest(_a, ["href"]);
  const isHttpLink = href === null || href === void 0 ? void 0 : href.startsWith("http");
  // eslint-disable-next-line @typescript-eslint/no-explicit-any
  const Tag = isHttpLink ? "a" : reactRouterDom.NavLink;
  const props = isHttpLink ? { href } : { to: href };
  return React__default.default.createElement(Tag, { role: "button", ...props, ...otherProps });
};
...
const PanelBody = function (_a) {
  ...
  return React__default.default.createElement(
    ...
    links.map(function (entry) {
      const Icon = Icons$2[entry.icon];
      const iconElement = React__default.default.createElement(Icon, { width: "24px", mr: "8px" });
      const calloutClass = entry.calloutClass ? entry.calloutClass : undefined;
      if (entry.disabled) {
        return React__default.default.createElement(
          DisabledMenuEntry,
          { key: entry.label, className: "test1" },
          React__default.default.createElement(
            MenuLink,
            { href: entry.href },
            iconElement,
            React__default.default.createElement(DisabledLinkLabelMemo, { isPushed, isDisabled: true }, entry.label),
            entry.status &&
              React__default.default.createElement(
                LinkStatus,
                { color: entry.status.color, fontSize: "14px" },
                entry.status.text
              )
          )
        );
      ...
      if (entry.items) {
        const itemsMatchIndex = entry.items.findIndex(function (item) {
        ...
        return React__default.default.createElement(
          ...
          isPushed &&
            entry.items.map(function (item) {
              return React__default.default.createElement(
                MenuEntry,
                { key: item.href, secondary: true, isActive: item.href === location.pathname, onClick: handleClick },
                React__default.default.createElement(
                  MenuLink,
                  { href: item.href },
                  React__default.default.createElement(LinkLabelMemo, { isPushed }, item.label),
                  item.status &&
                    React__default.default.createElement(
                      LinkStatus,
                      { color: item.status.color, fontSize: "14px" },
                      item.status.text
                    )
                )
              );
      ...
      return React__default.default.createElement(
        MenuEntry,
        { key: entry.label, isActive: entry.href === location.pathname, className: calloutClass },
        React__default.default.createElement(
          MenuLink,
          { href: entry.href, onClick: handleClick },
          iconElement,
          React__default.default.createElement(LinkLabelMemo, { isPushed }, entry.label),
          entry.status &&
            React__default.default.createElement(
              LinkStatus,
              { color: entry.status.color, fontSize: "14px" },
...
let templateObject_1$9;

const PriceLink = styled__default.default.a(
  templateObject_1$8 ||
...
const CakePrice = function (_a) {
  const { cakePriceUsd } = _a;
  return cakePriceUsd
    ? React__default.default.createElement(
        PriceLink,
        {
          href: "https://exchange.pancakeswap.finance/#/swap?outputCurrency=0xe7d7003fdac419325faca13403edeec94e80c048",
          target: "_blank",
        },
...
const CakePrice$1 = React__default.default.memo(CakePrice);
let templateObject_1$8;

const Icons$1 = IconModule;
const { MoonIcon } = Icons$1;
const { SunIcon } = Icons$1;
const ThemeSwitcher = function (_a) {
  const { isDark } = _a;
  const { toggleTheme } = _a;
  return React__default.default.createElement(
    Button,
    {
      variant: "text",
...
const ThemeSwitcher$1 = React__default.default.memo(ThemeSwitcher, function (prev, next) {
...
const SocialLinks = function () {
  return React__default.default.createElement(
    ...
    socials.map(function (social, index) {
      ...
      return React__default.default.createElement(
        Link,
        { external: true, key: social.label, href: social.href, "aria-label": social.label, mr },
        React__default.default.createElement(Icon, { ...iconProps })
      );
    })
  );
};
const SocialLinks$1 = React__default.default.memo(SocialLinks, function () {
  return true;
});

const LangSelector = function (_a) {
  const { currentLang } = _a;
  const { langs } = _a;
  const { setLang } = _a;
  return React__default.default.createElement(
    Dropdown,
    {
      position: "top-right",
      target: React__default.default.createElement(
        Button,
        {
          variant: "text",
          startIcon: React__default.default.createElement(Icon$1g, { color: "textSubtle", width: "24px" }),
        },
        React__default.default.createElement(
          Text,
          { color: "textSubtle" },
...
const LangSelector$1 = React__default.default.memo(LangSelector, function (prev, next) {
...
const SettingsEntry = styled__default.default.div(
  templateObject_2$2 ||
...
const SocialEntry = styled__default.default.div(
  templateObject_3$1 ||
...
const PanelFooter = function (_a) {
  ...
  return React__default.default.createElement(
    ...
    React__default.default.createElement(
      SocialEntry,
      null,
      React__default.default.createElement(CakePrice$1, { cakePriceUsd }),
      React__default.default.createElement(SocialLinks$1, null)
    ),
    React__default.default.createElement(
      SettingsEntry,
      null,
      React__default.default.createElement(ThemeSwitcher$1, { isDark, toggleTheme }),
      React__default.default.createElement(LangSelector$1, { currentLang, langs, setLang })
    )
  );
};
let templateObject_1$7;
let templateObject_2$2;
let templateObject_3$1;

const StyledPanel = styled__default.default.div(
  templateObject_1$6 ||
...
const Panel = function (props) {
  ...
  return React__default.default.createElement(
    StyledPanel,
    { isPushed, showMenu },
    React__default.default.createElement(PanelBody, { ...props }),
    React__default.default.createElement(PanelFooter, { ...props })
  );
};
let templateObject_1$6;

const Icon$7 = function (props) {
  return React__default.default.createElement(
    Svg,
...
const Icon$1 = function (props) {
  return React__default.default.createElement(
    Svg,
    { viewBox: "0 0 1000 1000", ...props },
    React__default.default.createElement(
      "defs",
      null,
      React__default.default.createElement(
        "linearGradient",
        { id: "prefix__a", x1: 48.733, y1: 944.09, x2: 942.955, y2: 64.09, gradientUnits: "userSpaceOnUse" },
      ...
      React__default.default.createElement(
        "linearGradient",
        { id: "prefix__b", x1: 761.394, y1: 238.668, x2: 275.02, y2: 725.043, gradientUnits: "userSpaceOnUse" },
...
const WalletCard = function (_a) {
  const { login } = _a;
  const { walletConfig } = _a;
  const { onDismiss } = _a;
  const { mb } = _a;
  const { title } = walletConfig;
  const Icon = walletConfig.icon;
  return React__default.default.createElement(
    Button,
    {
      width: "100%",
...
const HelpLink = styled__default.default(Link)(
  templateObject_1$5 ||
...
const ConnectModal = function (_a) {
  const { login } = _a;
  const _b = _a.onDismiss;
  const onDismiss =
    _b === void 0
      ? function () {
          return null;
  ...
  return React__default.default.createElement(
    Modal,
    { title: "Connect to a wallet", onDismiss },
    connectors.map(function (entry, index) {
      return React__default.default.createElement(WalletCard, {
        key: entry.title,
        login,
        walletConfig: entry,
        onDismiss,
    ...
    React__default.default.createElement(
      HelpLink,
      { href: "https://docs.pancakeswap.finance/get-started/connection-guide", external: true },
      React__default.default.createElement(Icon$1i, { color: "primary", mr: "6px" }),
      "Learn how to connect"
    )
  );
};
let templateObject_1$5;

const StyleButton = styled__default.default(Text).attrs({ role: "button" })(
  templateObject_1$4 ||
...
const CopyToClipboard = function (_a) {
  const { toCopy } = _a;
  const { children } = _a;
  const props = __rest(_a, ["toCopy", "children"]);
  const _b = React.useState(false);
  const isTooltipDisplayed = _b[0];
  const setIsTooltipDisplayed = _b[1];
  const copyToClipboardWithCommand = function (content) {
  ...
  return React__default.default.createElement(
    ...
    React__default.default.createElement(Tooltip, { isTooltipDisplayed }, "Copied")
  );
};
let templateObject_1$4;
let templateObject_2$1;

const AccountModal = function (_a) {
  const { account } = _a;
  const { logout } = _a;
  const _b = _a.onDismiss;
  const onDismiss =
  ...
  return React__default.default.createElement(
    ...
    React__default.default.createElement(
      ...
      React__default.default.createElement(
        LinkExternal,
        { small: true, href: `https://bscscan.com/address/${account}`, mr: "16px" },
        "View on BscScan"
      ),
...
const useWalletModal = function (login, logout, account) {
  const onPresentConnectModal = useModal(React__default.default.createElement(ConnectModal, { login }))[0];
  const onPresentAccountModal = useModal(
    React__default.default.createElement(AccountModal, { account: account || "", logout })
  )[0];
  return { onPresentConnectModal, onPresentAccountModal };
};

const UserBlock = function (_a) {
  const { account } = _a;
  const { login } = _a;
  const { logout } = _a;
  const _b = useWalletModal(login, logout, account);
  const { onPresentConnectModal } = _b;
  const { onPresentAccountModal } = _b;
...
const UserBlock$1 = React__default.default.memo(UserBlock, function (prevProps, nextProps) {
  return (
...
const BodyWrapper = styled__default.default.div(
  templateObject_3 ||
...
const MobileOnlyOverlay = styled__default.default(Overlay)(
  templateObject_5 ||
...
const Menu = function (_a) {
  ...
  const _c = React.useState(!isMobile);
  const isPushed = _c[0];
  const setIsPushed = _c[1];
  const _d = React.useState(true);
  const showMenu = _d[0];
  const setShowMenu = _d[1];
  ...
  const homeLink = links.find(function (link) {
  ...
  return React__default.default.createElement(
    ...
    React__default.default.createElement(
      StyledNav,
      { showMenu },
      React__default.default.createElement(Logo$1, {
        isPushed,
        togglePush() {
        ...
        isDark,
        href:
          (_b = homeLink === null || homeLink === void 0 ? void 0 : homeLink.href) !== null && _b !== void 0 ? _b : "/",
      }),
      !!login &&
        !!logout &&
        React__default.default.createElement(
          Flex,
          null,
          React__default.default.createElement(UserBlock$1, { account, login, logout })
        )
    ),
    React__default.default.createElement(
      BodyWrapper,
      ...
      React__default.default.createElement(Inner, { isPushed, showMenu }, children),
      React__default.default.createElement(MobileOnlyOverlay, {
        show: isPushed,
        onClick() {
...
const alertTypeMap =
  ...
  _a);
const StyledToast = styled__default.default.div(
  templateObject_1$2 ||
...
const Toast = function (_a) {
  const { toast } = _a;
  const { onRemove } = _a;
  const { style } = _a;
  const { ttl } = _a;
  const props = __rest(_a, ["toast", "onRemove", "style", "ttl"]);
  const timer = React.useRef();
  const ref = React.useRef(null);
  const removeHandler = React.useRef(onRemove);
  const { id } = toast;
  const { title } = toast;
  const { description } = toast;
  const { type } = toast;
  ...
  return React__default.default.createElement(
    ...
    { nodeRef: ref, timeout: 250, style, ...props },
    React__default.default.createElement(
      StyledToast,
      { ref, onMouseEnter: handleMouseEnter, onMouseLeave: handleMouseLeave },
      React__default.default.createElement(
        Alert,
        { title, variant: alertTypeMap[type], onClick: handleRemove },
        description
      )
    )
  );
};
let templateObject_1$2;

const ZINDEX = 1000;
const TOP_POSITION = 80; // Initial position from the top
const StyledToastContainer = styled__default.default.div(
  templateObject_1$1 ||
...
const ToastContainer = function (_a) {
  const { toasts } = _a;
  const { onRemove } = _a;
  const _b = _a.ttl;
  const ttl = _b === void 0 ? 6000 : _b;
  const _c = _a.stackSpacing;
  const stackSpacing = _c === void 0 ? 24 : _c;
  return React__default.default.createElement(
...
exports.ArrowFirstIcon = Icon$1H;
exports.ArrowForwardIcon = Icon$1G;
exports.ArrowLastIcon = Icon$1F;
...
exports.PencilIcon = Icon$10;
exports.PlayCircleOutlineIcon = Icon$Z;
exports.PocketWatchIcon = Icon$_;
...
exports.VoteIcon = Icon$y;
exports.WaitIcon = Icon$T;
exports.WalletFilledIcon = Icon$u;
exports.WalletIcon = Icon$v;
